# GBP content pack - Hirshmans Chemist (Ainsdale)

Branch id: hirshmans_ainsdale (branches.json). Drafted 2026-08-04.
Facts checked against branches.json (hours confirmed by NHS 2026-06-24).
Ready for Rishi or Dane to paste into GBP.

NOTE (Q4 on the portal): the McCanns Sandringham GBP description is currently
a copy of Hirshmans text naming two POM weight loss medicines. When pasting
this pack, also check the Hirshmans live description itself for medicine
names and replace it with the description below.

Profile basics (for checking, not pasting):
- Name on GBP: Hirshmans Chemist
- Address: 56-62 Sherwood House, Station Road, Ainsdale, Southport PR8 3HW
- Phone: 01704 577376
- Hours: Monday to Friday 8:30am to 6:00pm (closed 1:00pm to 2:00pm),
  Saturday 9:00am to 5:30pm (closed 1:00pm to 2:00pm), Sunday closed
...
- NOTE: the current GBP listing name is "Hirshmans Pharmacy - Travel
...
NHS services first:
- NHS prescription dispensing: while-you-wait dispensing, free GP pick-up
  and free home delivery around Ainsdale, Birkdale and Southport.
...
at Hirshmans Chemist in Ainsdale. Our pharmacists can assess and, where
...
across Ainsdale, Birkdale and Southport, plus blister packs if you want your
medicines organised by day. Open Saturdays too - a local team on Station
Road you can actually speak to.
Button: Learn more -> https://www.hirshmanspharmacy.co.uk/switch-prescriptions-hirshmans-ainsdale.html

### Post C - Weight loss clinic
Thinking about losing weight with proper support? Our pharmacist-led weight
loss clinic at Hirshmans Chemist in Ainsdale starts with a private, no
...
- HARD STOP, Post A: do not post with the current button link. The old
  ...
  publishes a phone number that does not dial (017014577376), the wrong
  street address (64 Station Road instead of 56-62 Sherwood House) and
  the old "Hirshmans Pharmacy" branding (checked live 2026-08-12). The
  generated replacement is already live and correct at
  https://www.hirshmanspharmacy.co.uk/pharmacy-first-hirshmans-ainsdale.html
  so this is one of the item 5.3 links that needs no paste, only the
  repoint decision (Q8/Q34). Until that lands, Post A stays unposted.
