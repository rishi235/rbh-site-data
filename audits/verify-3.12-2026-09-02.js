/*
  verify-3.12-2026-09-02.js - independent machine pass on item 3.12
  (Tiffenbergs Chemist, Aintree, single branch, 12 pages), fifth pass,
  following 2026-08-14, 2026-08-30, 2026-08-31 and 2026-09-01.
  ...
  module JS files as data only. Repo root resolved relative to this file
  (portable across the Linux sandbox mount and the Windows checkout,
  unlike the 2026-08-30 script which hardcoded C:/Dev/rbh-site-data).

  Legs follow the single-branch template proved on 3.5/3.7/3.8/3.9/3.12:
...
console.log("verify-3.12 (fifth pass, 2026-09-02): " + pagesChecked + " Tiffenbergs pages checked, " + Object.keys(sheetByPermalink).length + " sheet permalinks parsed, " + checksRun + " checks run");
if (fails.length) {
