/*
  verify-3.12-2026-09-01.js - independent machine pass on item 3.12
  (Tiffenbergs Chemist, Aintree, single branch, 12 pages), fourth pass,
  following 2026-08-14, 2026-08-30 and 2026-08-31.
...
console.log("verify-3.12 (fourth pass, 2026-09-01): " + pagesChecked + " Tiffenbergs pages checked, " + Object.keys(sheetByPermalink).length + " sheet permalinks parsed, " + checksRun + " checks run");
if (fails.length) {
